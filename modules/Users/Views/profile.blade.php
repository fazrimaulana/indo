            ...
            <div class="profile-sidebar">
                ...
                <div class="portlet light profile-sidebar-portlet ">
                    ...
                    <div class="profile-userpic">
                        @if($user->photo==null)
                            <img src="{{ url('/backend/assets/pages/media/profile/profile_user.jpg') }}" class="img-responsive" alt="">
                        @else
                            <img src="{{ url($user->photo) }}" class="img-responsive" alt="" style="height: 150px; width: 150px;">
                        @endif
                    </div>
                    <!-- END SIDEBAR USERPIC -->
                    <!-- SIDEBAR USER TITLE -->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_1_2">
                                        ...
                                        <div class="margin-top-10">
                                            <button type="submit" class="btn green"> Save Change </a>
